	...
	function widget($args, $instance) {
		...
		?>
			...
			<li class="recent-post-item">
				<?php if ( $instance['excerpt'] || $instance["thumb"] ) : ?>				<?php					if (						function_exists('the_post_thumbnail') &&						current_theme_supports("post-thumbnails") &&						$instance["thumb"] &&						has_post_thumbnail()					) :										  $thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID),'full');					  $plugin_dir = 'advanced-recent-posts-widget';				?>					<div class="post-image">						<div class="post-mask"></div>						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">							<img width="70" height="70" src="<?php echo WP_PLUGIN_URL . '/' . $plugin_dir .'/'.'timthumb/thumb.php?src='. $thumbnail[0] .'&h='.$thumb_h.'&w='.$thumb_w.'&z=0'; ?>" class="attachment-post-widget #"  />                						</a>					</div>									<?php endif; ?>				<?php endif; ?>                <h6><a href="<?php the_permalink(); ?>" ><?php the_title(); ?></a></h6>                <span><?php the_time("j M Y"); ?></span>                <div class="clear"></div>
			</li>
